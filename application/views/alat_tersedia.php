...
<head>
    <base href="../../../">
    <meta charset="utf-8" />
    <title>Kelola Alat Praktikum </title>
...
<body id="kt_body" class="header-fixed header-mobile-fixed subheader-enabled subheader-fixed aside-enabled aside-fixed page-loading">
    ...
    <div id="kt_header_mobile" class="header-mobile align-items-center header-mobile-fixed">
        <!--begin::Logo-->
        <a href="index.html">
            <img alt="Logo" class="w-45px" src=https://1.bp.blogspot.com/-PpH7CcrJIvE/X5WGsZUp6LI/AAAAAAAADRE/VIw1_NyjUC4HUnijuO1r2WBG4tfjpJGbgCLcBGAsYHQ/w1200-h630-p-k-no-nu/Logo%2BPolinema%2B%2528Politeknik%2BNegeri%2BMalang%2529.png />
        </a>
        <!--end::Logo-->
        <!--begin::Toolbar-->
