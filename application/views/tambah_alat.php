...
<head>
    ...
    <!--end::Layout Themes-->
    <link rel="shortcut icon" href=https://1.bp.blogspot.com/-PpH7CcrJIvE/X5WGsZUp6LI/AAAAAAAADRE/VIw1_NyjUC4HUnijuO1r2WBG4tfjpJGbgCLcBGAsYHQ/w1200-h630-p-k-no-nu/Logo%2BPolinema%2B%2528Politeknik%2BNegeri%2BMalang%2529.png />
</head>
<!--end::Head-->
<!--begin::Body-->
            ...
            <div class="aside aside-left aside-fixed d-flex flex-column flex-row-auto" id="kt_aside">
                ...
                <div class="brand flex-column-auto" id="kt_brand">
                    ...
                    <a href="index.html" class="brand-logo">
                        <img alt="Logo" class="w-150px" src=https://1.bp.blogspot.com/-PpH7CcrJIvE/X5WGsZUp6LI/AAAAAAAADRE/VIw1_NyjUC4HUnijuO1r2WBG4tfjpJGbgCLcBGAsYHQ/w1200-h630-p-k-no-nu/Logo%2BPolinema%2B%2528Politeknik%2BNegeri%2BMalang%2529.png />
                    </a>
                    <!--end::Logo-->
                </div>
                <!--end::Brand-->
                                    ...
                                    <ul class="menu-subnav">
                                        <li class="menu-item menu-item-parent" aria-haspopup="true">
                                            <span class="menu-link">
                                                <span class="menu-text"> Kelola Alat Praktikum </span>
                                            </span>
                                        </li>
                                        <li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
                                            <a href="javascript:;" class="menu-link menu-toggle">
                                ...
                                <div class="col-md-15">
                                    ...
                                    <div class="card card-custom gutter-b example example-compact">
                                        <div class="card-header">
                                            <h3 class="card-title">Tambah Alat Praktikum</h3>
                                        ...
                                        <form class="form">
                                                    ...
                                                    <div class="alert alert-custom alert-default" role="alert">
                                                        <div class="alert-icon">
                                                            <span class="svg-icon svg-icon-primary svg-icon-xl">
                                                                <!--begin::Svg Icon | path:<?php echo base_url('demo13/dist/assets/') ?>media/svg/icons/Tools/Compass.svg-->
                                                                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                                                    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                            ...
                                            <div class="card-footer">
                                                <button type="reset" class="btn btn-primary mr-2">Tambahkan</button>
