            ...
            <div class="row justify-content-center">
                <div class="col-md-9">
                    ...
                    <div class="card card-body" style="margin-bottom: 40px;">
                        ...
                        <p class="text-center">Halaman yang digunakan untuk melakukan pengembalian barang</p>
                        
                        <!-- <input type="text" class="form-control" name="search" placeholder="NIM . . ." /> -->
                        
                        <form action="<?php echo base_url('peminjaman_alat/pengembalian') ?>" method="GET">
                        <div class="form-group">
                        	<div class="input-group">
                        		<input type="search" name="search" class="form-control" placeholder="Cari NIM atau Nama Mahasiswa . . ." />
                        		<div class="input-group-append">
                        			<button class="btn btn-light-warning" type="submit">
                                        <span><i class="flaticon2-search-1 icon-md"></i></span> Cari NIM
                                    </button>
                        		</div>
                        	</div>
                        </div>
                        <small>Masukkan NIM</small>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            <div class="card card-body">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <small><b>Opsi Lanjutan</b></small><br>
                                        <a href="javascript:;" data-toggle="modal" data-target="#exampleModal" class="btn btn-sm btn-light-primary">Setujui Pengembalian Barang</a>
                                        ...
                                        <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                            <div class="modal-dialog modal-dialog-centered" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <form action="<?php echo base_url('peminjaman_alat/konfirmasi_admin/'. $peminjaman[0]['id_peminjaman']) ?>" method="post">
                                                    <div class="modal-body">
                                                        ...
                                                        <p>"Pastikan alat sudah diperiksa"</p>

                                                        <textarea name="keterangan" class="form-control" placeholder="Berikan Keterangan . . ."></textarea>
                                                        <small>Masukkan keterangan bila perlu</small>
                                                    </div>
                                                    <div class="modal-footer">
                                                        <button type="button" class="btn btn-light-primary font-weight-bold" data-dismiss="modal">Close</button>
                                                        <button type="submit" class="btn btn-primary font-weight-bold">Setujui Pengembalian</button>
                                                    </div>
                                                    </form>
                                ...
                                <table class="table table-stripe">
                                    ...
                                    <tr> 
                                        ...
                                        <td>
                                            <a href="javascript:;" class="btn btn-icon btn-sm btn-light-danger" data-toggle="modal" data-target="#pelaporan-<?php echo $nomor ?>">
                                            ...
                                            <!-- Modal-->
                                            <div class="modal fade" id="pelaporan-<?php echo $nomor ?>"tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                <div class="modal-dialog modal-dialog-centered modal-sm" role="document">
                                                    <div class="modal-content">


                                                        <form action="<?php echo base_url('peminjaman_alat/lapor_barang_rusak/') ?>" method="POST" enctype="multipart/form-data">
                                                    	<div class="modal-body">
                                                    		...
                                                    		<h2>Pelaporan Kerusakan</h2>
                                                    		<small>Isi keterangan detail mengenai kerusakan barang</small>
                                                    		...
                                                    		<div class="form-group">
                                                    			...
                                                    			<small>Masukkan dokumentasi (Opsional)</small>
                                                    		</div>
                                                    	...
                                                    	<div class="modal-footer">
                                                    		...
                                                    		<button type="submit"
                                                    			class="btn btn-danger font-weight-bold">Tambah Laporan</button>
                                                    	</div>
                                                        </form>
                                                    </div>
                                                </div>
                    ...
                    <?php } else { ?>
                        ...
                        <div class="row">
                            <div class="col-md-12 text-center">
                                ...
                                <p>NIM : <?php echo $this->input->get('search') ?> tidak ditemukan atau tidak sedang melakukan peminjaman</p>
                            </div>
                        </div> 
                    ...
                    <?php } else { ?>
                        ...
                        <div class="row">
                            <div class="col-md-12 text-center">
                                <?php echo svg_start() ?>
                                <h3>Lakukan Pencarian Mahasiswa</h3>
                                <p>Berdasarkan NIM yang telah terdaftar atau pernah melakukan peminjaman</p>
                            </div>
                        </div>
                    <?php } ?>
