									...
									<div class="wizard-step flex-grow-1 flex-basis-0" data-wizard-type="step" data-wizard-state="current">
										<div class="wizard-wrapper pr-7">
											...
											<div class="wizard-label">
												...
												<div class="wizard-desc">Detail akun</div>
											</div>
									...
									<div class="wizard-step flex-grow-1 flex-basis-0" data-wizard-type="step">
										<div class="wizard-wrapper pr-7">
											...
											<div class="wizard-label">
												...
												<div class="wizard-desc">Alamat tempat tinggal</div>
											</div>
											<span class="svg-icon pl-6">
												<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
													<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
									...
									<div class="wizard-step flex-grow-1 flex-basis-0" data-wizard-type="step">
										<div class="wizard-wrapper">
											...
											<div class="wizard-label">
												...
												<div class="wizard-desc">Selesai daftar</div>
											</div>
										</div>
									</div>
							...
							<form class="form px-10" novalidate="novalidate" id="kt_login_signup_form">
								...
								<div class="" data-wizard-type="step-content" data-wizard-state="current">
									...
									<div class="pb-10 pb-lg-12">
										...
										<a href="custom/pages/login/login-4/signin.html" class="text-primary font-weight-bolder">Masuk</a></div>
									</div>
									<!--begin::Title-->
									<!--begin::Form Group-->
									<div class="form-group">
										<label class="font-size-h6 font-weight-bolder text-dark">Nama Depan</label>
										<input type="text" class="form-control form-control-solid h-auto py-7 px-6 border-0 rounded-lg font-size-h6" name="fname" placeholder="Nama Depan" value="" />
									</div>
									<!--end::Form Group-->
									<!--begin::Form Group-->
									<div class="form-group">
										<label class="font-size-h6 font-weight-bolder text-dark">Nama Belakang</label>
										<input type="text" class="form-control form-control-solid h-auto py-7 px-6 border-0 rounded-lg font-size-h6" name="lname" placeholder="Nama Belakang" value="" />
									</div>
									<!--end::Form Group-->
								</div>
								<!--end: Wizard Step 1-->
								...
								<div class="pb-5" data-wizard-type="step-content">
									...
									<div class="pt-lg-0 pt-5 pb-15">
										<h3 class="font-weight-bolder text-dark font-size-h2 font-size-h1-lg">Alamat Detail</h3>
										<div class="text-muted font-weight-bold font-size-h4">Apakah ada alamat yang lain ?
										<a href="#" class="text-primary font-weight-bolder">Tambah Alamat</a></div>
									</div>
									<!--begin::Title-->
									<!--begin::Row-->
									<div class="row">
										<div class="col-xl-6">
											<!--begin::Input-->
											<div class="form-group">
												<label class="font-size-h6 font-weight-bolder text-dark">Alamat 1</label>
												<input type="text" class="form-control form-control-solid h-auto py-7 px-6 border-0 rounded-lg font-size-h6" name="address1" placeholder="Alamat 1" value="Alamat 1" />
										...
										<div class="col-xl-6">
											<!--begin::Input-->
											<div class="form-group">
												<label class="font-size-h6 font-weight-bolder text-dark">Alamat 2</label>
												<input type="text" class="form-control form-control-solid h-auto py-7 px-6 border-0 rounded-lg font-size-h6" name="address2" placeholder="Alamat 2" value="Alamat 2" />
												<span class="form-text text-muted">Masukkan Alamat.</span>
											</div>
											<!--end::Input-->
										</div>
									...
									<div class="row">
										<div class="col-xl-6">
											<!--begin::Input-->
											<div class="form-group">
												<label class="font-size-h6 font-weight-bolder text-dark">Negara</label>
								...
								<div class="pb-5" data-wizard-type="step-content">
									<!--begin::Title-->
									<div class="pt-lg-0 pt-5 pb-15">
										<h3 class="font-weight-bolder text-dark font-size-h2 font-size-h1-lg">Selesai</h3>
										<div class="text-muted font-weight-bold font-size-h4">Lengkapi Pendaftaran Anda Dan Menjadi Anggota!</div>
									</div>
									<!--end::Title-->
									<!--begin::Section-->
									<h4 class="font-weight-bolder mb-3">Pengaturan Akun:</h4>
									<div class="text-dark-50 font-weight-bold line-height-lg mb-8">
										<div>Putrisekar</div>
										<div>+6281257588545</div>
										<div>putri.sekar@gmail.com</div>
									</div>
									<!--end::Section-->
									<!--begin::Section-->
									<h4 class="font-weight-bolder mb-3">Alamat Detail:</h4>
									<div class="text-dark-50 font-weight-bold line-height-lg mb-8">
										<div>Alamat 1</div>
										<div>Alamat 2</div>
										<div>Indonesia 3000, Indonesia, Indonesia</div>
									</div>
									<!--end::Section-->
								</div>
								<!--end: Wizard Step 5-->
								...
								<div class="d-flex justify-content-between pt-7">
									<div class="mr-2">
										...
										<span class="svg-icon svg-icon-md mr-2">
											<!--begin::Svg Icon | path:<?php echo base_url('demo13/dist/assets/') ?>media/svg/icons/Navigation/Left-2.svg-->
											<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
												<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
													<polygon points="0 0 24 0 24 24 0 24" />
									...
									<div>
										<button class="btn btn-primary font-weight-bolder font-size-h6 pl-8 pr-4 py-4 my-3" data-wizard-type="action-submit" type="submit" id="kt_login_signup_form_submit_button">Masuk
										<span class="svg-icon svg-icon-md ml-2">
											<!--begin::Svg Icon | path:<?php echo base_url('demo13/dist/assets/') ?>media/svg/icons/Navigation/Right-2.svg-->
											<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
												<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
													<polygon points="0 0 24 0 24 24 0 24" />
													<rect fill="#000000" opacity="0.3" transform="translate(8.500000, 12.000000) rotate(-90.000000) translate(-8.500000, -12.000000)" x="7.5" y="7.5" width="2" height="9" rx="1" />
										...
										<button type="button" class="btn btn-primary font-weight-bolder font-size-h6 pl-8 pr-4 py-4 my-3" data-wizard-type="action-next">Selanjutnya
										<span class="svg-icon svg-icon-md ml-2">
											<!--begin::Svg Icon | path:<?php echo base_url('demo13/dist/assets/') ?>media/svg/icons/Navigation/Right-2.svg-->
											<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
												<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
