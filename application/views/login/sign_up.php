								...
								<div class="wizard-steps d-flex flex-column flex-sm-row">
									...
									<div class="wizard-step flex-grow-1 flex-basis-0" data-wizard-type="step">
										<div class="wizard-wrapper pr-7">
											...
											<div class="wizard-label">
												<h3 class="wizard-title">Detail Akun</h3>
												<div class="wizard-desc">Username dan Password</div>
											</div>
											<span class="svg-icon pl-6">
												<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
													<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
							...
							<form class="form px-10" novalidate="novalidate" id="kt_login_signup_form">
								...
								<div class="pb-5" data-wizard-type="step-content">
									...
									<div class="pt-lg-0 pt-5 pb-15">
										<h3 class="font-weight-bolder text-dark font-size-h2 font-size-h1-lg">Username dan Password</h3>
									</div>
									<!--begin::Title-->
									<!--begin::Row-->
									<div class="row">
										<div class="col-xl-6">
											...
											<div class="form-group">
												...
												<input type="text" class="form-control form-control-solid h-auto py-7 px-6 border-0 rounded-lg font-size-h6" name="address1" placeholder="Username" value="Username" />
										...
										<div class="col-xl-6">
											...
											<div class="form-group">
												...
												<input type="text" class="form-control form-control-solid h-auto py-7 px-6 border-0 rounded-lg font-size-h6" name="address2" placeholder="Password" value="Password" />
									...
									<div class="row">
										<div class="col-xl-6">
											<!--begin::Input-->
											<div class="form-group">
												<label class="font-size-h6 font-weight-bolder text-dark">Masukkan Ulang Password </label>
												<input type="text" class="form-control form-control-solid h-auto py-7 px-6 border-0 rounded-lg font-size-h6" name="Masukkan Ulang Password" placeholder="Masukkan Ulang Password" value="Masukkan Ulang Password" />
												<span class="form-text text-muted">Masukkan Ulang Password</span>
											</div>
											<!--end::Input-->
										</div>
									</div>
